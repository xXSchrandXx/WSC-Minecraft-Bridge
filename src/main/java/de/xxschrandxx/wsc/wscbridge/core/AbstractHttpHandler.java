...
public abstract class AbstractHttpHandler implements HttpHandler {
     ...
     * @see de.xxschrandxx.wsc.wscbridge.bungee.handler.StatusHandler#run(HttpExchange)
     * @see de.xxschrandxx.wsc.wscbridge.bukkit.handler.StatusHandler#run(HttpExchange)
