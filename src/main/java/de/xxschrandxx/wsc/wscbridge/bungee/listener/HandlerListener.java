...
import de.xxschrandxx.wsc.wscbridge.bungee.api.MinecraftBridgeEvent;

import de.xxschrandxx.wsc.wscbridge.bungee.handler.*;
import de.xxschrandxx.wsc.wscbridge.bungee.handler.permission.*;
    ...
    public void onEnable(MinecraftBridgeEvent event) {
        ...
        if (instance.getConfiguration().getBoolean(MinecraftBridgeVars.Configuration.modules.groupsync.enabled)) {
            ...
            switch (plugin) {
                ...
                case Vault:
                    instance.getLogger().log(Level.WARNING, "WebServer: " + plugin.getName() + " is not supported for BungeeCord.");
            }
