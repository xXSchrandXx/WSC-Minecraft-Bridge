...
import de.xxschrandxx.wsc.core.permission.VaultMethods;
import net.milkbowl.vault.permission.Permission;

public class VaultPermissionHandler extends VaultMethods {

    private final PermissionMethodEnum method;

    public VaultPermissionHandler(PermissionMethodEnum method) {
        super(Bukkit.getServer().getServicesManager().getRegistration(Permission.class).getProvider());
        this.method = method;
    }
